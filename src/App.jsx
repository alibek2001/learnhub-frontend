...
import { mockLoadUserData } from './services/operations/mockAuthAPI'
...
function App() {
    ...
    // Загрузка данных пользователя при инициализации приложения
    useEffect(() => {
        dispatch(mockLoadUserData())
    }, [dispatch])
        ...
        <div className='w-screen min-h-screen bg-richblack-900 flex flex-col font-inter'>
            ...
            <Routes>
                ...
                >
                    ...
                    {/* cart , EnrolledCourses, AllCourses */}
